...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('[','white'), color('!','red'), color(']','white'), color('SC BY RAMLAN RECODE BY RIZ'))
})
...
baby.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `▬▭▬▭▬❰ *BOT* ❱▭▬▭▬▭\n║╭━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╮\n║│【✿͜͡➳ *${mdata.subject}*\n║│【✿͜͡➳ *@${num.split('@')[0]} Intro/Dikick \n║│【✿͜͡➳ *Nama* : \n║│【✿͜͡➳ *Umur* : \n║│【✿͜͡➳ *Askot* : \n║│【✿͜͡➳ *Gender* : \n║│【✿͜͡➳ *Udah Punya Doi/Blm*: \n║│【✿͜͡➳ *alasan bergabung??* \n║│【✿͜͡➳ *Instagram?* \n║╰━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╯\n▬▭▬▭▬▭▬▭▬▭▬▭▬\n*baca deskripsi grub yaa*\n▬▭▬▭▬❰ *DESK* ❱▭▬▭▬▭\n║╭━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╮\n║│【✿͜͡➳ _KETIK *menu* & *help*_\n║│【✿͜͡➳ *EMOJI🚫ARTI DILARANG*\n║│【✿͜͡➳ _1. OWNER SELALU BENAR_\n║│【✿͜͡➳ _2.  SPAM BOT🚫_\n║│【✿͜͡➳ _3.  ADD BOT LAIN🚫_\n║│【✿͜͡➳ _4. PERINGATAN TOXIC 5×_\n║│【✿͜͡➳ _5. HINA BOT🚫_\n║│【✿͜͡➳ _6. BERBAU +18 🚫_\n║│【✿͜͡➳ _7. CULIK BOT 🚫_\n║│【✿͜͡➳ _8. NGEMIS ADMIN🚫_\n║│【✿͜͡➳ _9. SHARE LINK🚫_\n║│【✿͜͡➳ _10. NABUNG CHAT🚫_\n║│【✿͜͡➳ _11. CUMA NYIMAK🚫_\n║╰━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╯\n▬▭▬▭▬▭▬▭▬▭▬▭▬\nBACA JADWAl JUGA\n▬▭▬▭▬❰ *BOT* ❱▭▬▭▬▭\n║╭━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╮\n║│【✿͜͡➳ *JADWAL BOT*\n║│【✿͜͡➳ _ONLINE : 07.00 WITA_\n║│【✿͜͡➳ _OFFLINE : 21.00 WITA_\n║╰━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╯\n▬▭▬▭▬▭▬▭▬▭▬▭▬`
				...
				teks = `SELAMAT TINGGAL... @${num.split('@')[0]}👋* \n_Jasamu akan saya kubur dalam dalam dan jangan pernah kembali lagi !!! karena kami tidak butuh sampah seperti kamu_`
				let buff = await getBuffer(ppimg)
				baby.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
switch(command) {
        ...
        if (!isPrem) return reply(ind.premium())
			   ...
			   reply(mess.wait)
                    ...
                    teks = body.slice(9)
                    anu = await fetchJson(`https://api.vhtear.com/nekosearch?query=${teks}&apikey=$VhtearKey}`, {method: 'get'})
                    teks = `===============\n`
          ...
          case 'stalktiktok':
					...
					if (!isUser) return reply(mess.only.userB)
					if (isLimit(sender)) return reply(limitend(pushname2))
					if (args.length < 1) return baby.sendMessage(from, 'Usernamenya mana gan?', text, {quoted: mek})
          ...
          case 'playstore':
                ...
                if (isLimit(sender)) return reply(limitend(pushname2)) 
                ps = `${body.slice(11)}`
                  anu = await fetchJson(`https://api.vhtear.com/playstore?query=${ps}&apikey=${VhtearKey}`, {method: 'get'})
                  store = '======================\n'
           ...
           case 'afk':
				...
				if (!isPrem) return reply(ind.premium())
                                        ...
                                        baby.sendMessage(from, tag, text, {quoted: mek})
                                        break								
/*
]=====> SIMPLE MENU <=====[
*/
				...
				if (isBanned) return reply(ind.baned())
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply(`Kirim gambar/video/gif dengan caption \n${prefix}sticker (durasi sticker video 1-6 detik)`)
					}
					break
				case 'nulis1':
				case 'tulis1':
        ...
        case 'quote' :													
				...
				var nin = gh.split("&")[0];
				var ja = gh.split("&")[1];
				if (args.length < 1) return reply(`「❗」Contoh : ${prefix}ninjalogo nayla & cans`)
				reply(ind.wait())
		...
		case 'halloweentext':
		    ...
		    break
				...
				var porn = gh.split("&")[0];
				var hub = gh.split("&")[1];
				if (args.length < 1) return reply(`「❗」Contoh : ${prefix}pornhub nayla & Hub`)
				reply(ind.wait())
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					var gem = gh.split("&")[0];
					var bok = gh.split("&")[1];
					if (args.length < 1) return reply(`「❗」Contoh : ${prefix}gemboktext 11 01 2021 & nayla dan gak ada`)
					reply(ind.wait())
				...
				if (!isPrem) return reply(ind.premium())
					...
					var gli = gh.split("&")[0];
					var tch = gh.split("&")[1];
					if (args.length < 1) return reply(`「❗」Contoh : ${prefix}glitchtext nayla & cans`)
					reply(ind.wait())
				...
				if (!isRegistered) return reply(ind.noregis())
				if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (args.length < 1) return baby.sendMessage(from, `Kode bahasanya mana kak? contoh : ${prefix}tts id Halo nayla`, text, {quoted: mek})
...
case 'neontext':
				...
				if (!isRegistered) return reply(ind.noregis())
				if (!isPrem) return reply(ind.premium())
if (args.length < 1) return reply(`「❗」Contoh : ${prefix}neontext nayla`)
neon = body.slice(10)
reply('*[❗] SEDANG DI PROSES.*\n*NOTE* : _BENTAR DOANG KOK. GAK KEK DIA_')
 ...
 if (!isUser) return reply(mess.only.userB)
           ...
           case 'demote':
                ...
                if (!isRegistered) return reply(ind.noregis())				
					...
					if (!isGroupAdmins) return reply(ind.admin())
					if (!isBotGroupAdmins) return reply(ind.badmin())
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag target yang ingin anda bunuh!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						...
						mentions(`Berhasil Membunuh : @${mentioned[0].split('@')[0]}`, mentioned, true)
						baby.groupRemove(from, mentioned)
						}
					break
                 case 'fitnah':
...
*/
                ...
                addKoinUser('62812874133914@s.whatsapp.net', fee)
        ...
        if (args.length < 1) return reply(`Mau beli berapa berapa kak?`)
				const koinPerlimit = 1000
				const total = koinPerlimit * payout
				if ( checkATMuser(sender) <= total) return reply(`maaf kak uang nya gak cukup, kumpulin uang nya dumlu >_< kak:v`)
...
*/
          ...
          case 'waifu':
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
                   if (!isGroup) return reply(ind.groupo())
                   if (!isNsfw) return reply(ind.nsfwoff())
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=${TobzKey}`)
						buffer = await getBuffer(res.image)
						baby.sendMessage(from, buffer, image, {quoted: mek, caption: '>_<'})
					await limitAdd(sender)
					break
...
*/				
            	case 'mining':
                      ...
                      if (!isEventon) return reply(`maaf ${pushname} event mining tidak di aktifkan sama owner nayla`)
                      if (isOwner) {
                      const one = 999999999
			...
			break
				...
				case 'info':
					...
					teks = `▬▭▬▭▬❰ *INFO* ❱▭▬▭▬▭\n║╭━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╮\n║│【✿͜͡➳ *Nama bot* : ${me.name}\n║│【✿͜͡➳ *OWNER* : NAYLA\n║│【✿͜͡➳ *AUTHOR* : ${ownerName}\n║│【✿͜͡➳ *Nomor Bot* : @${me.jid.split('@')[0]}\n║│【✿͜͡➳ *Prefix* : ${prefix}\n║│【✿͜͡➳ *Total Block Contact* : ${blocked.length}\n║│【✿͜͡➳ *The bot is active on* : ${kyun(uptime)}\n║╰━⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱⋆⋆⃟⊱━╯\n▬▭▬▭▬▭▬▭▬▭▬▭▬`
            ...
            case 'creator':
                  ...
                  baby.sendMessage(from, 'Tuh Nomor owner ku [(>_<)], jangan kasarin yaa',MessageType.text, { quoted: mek} )
					break
case 'hartatahta':
if (isBanned) return reply(ind.baned())
if (!isRegistered) return reply(ind.noregis())
...
*/
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							baby.sendMessage(_.jid, buff, image, {caption: `*「 TITAN BROADCAST 」*\n\n${body.slice(4)}`})
						}
						reply('')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*「 TITAN BROADCAST 」*\n\n${body.slice(4)}`)
						}
						reply('*「 SUKSES KAK 」*')
					}
					break
